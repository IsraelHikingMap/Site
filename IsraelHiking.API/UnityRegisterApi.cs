...
namespace IsraelHiking.API
{
    ...
    public static class UnityRegisterApi
    {
        public static void RegisterUnityTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IMathTransform, ItmWgs84MathTransfrom>(new InjectionConstructor(false));
            ...
            container.RegisterType<IOsmGeoJsonPreprocessorExecutor, OsmGeoJsonPreprocessorExecutor>();
