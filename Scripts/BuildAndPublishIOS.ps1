...
Invoke-Expression "& openssl aes-256-cbc -k $env:PASSWORD -in ./signing/appveyor.mobileprovisionshareext.enc -d -a -out ./signing/appveyor.mobileprovisionshareext"
...
Copy-Item "./signing/appveyor.mobileprovisionshareext" -Destination "~/Library/MobileDevice/Provisioning Profiles/"
