...
openssl version
Invoke-Expression "& openssl aes-256-cbc -pbkdf2 -k $env:PASSWORD -in ./signing/appveyor.mobileprovision.enc -d -a -out ./signing/appveyor.mobileprovision"
Invoke-Expression "& openssl aes-256-cbc -pbkdf2 -k $env:PASSWORD -in ./signing/ihm-dist.cer.enc -d -a -out ./signing/ihm-dist.cer"
Invoke-Expression "& openssl aes-256-cbc -pbkdf2 -k $env:PASSWORD -in ./signing/ihm-dist.p12.enc -d -a -out ./signing/ihm-dist.p12"
