/**
 * From https://github.com/aaronlidman/osm-and-geojson
 * 
 */
    ...
    function Relations(wayCache) {
        ...
        for (var r = 0; r < relations_length; r++) {
            ...
            if (feature.properties.type == 'multipolygon') {
                ...
                feature = getFeature(relations[r], 'MultiLineString');
                for (var m = 0; m < members.length; m++) {
                    var ref = attr(members[m], 'ref'),
                    way = wayCache[ref];
