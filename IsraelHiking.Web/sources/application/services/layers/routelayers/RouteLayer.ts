...
import { IRouteLayer, IRoute, IRouteProperties, IRouteSegment, IMarkerWithData, EditModeString } from "./IRouteLayer";
...
import { ISnappingResponse, ISnappingOptions } from "../../SnappingService"
