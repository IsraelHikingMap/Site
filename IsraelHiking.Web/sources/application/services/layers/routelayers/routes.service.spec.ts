...
import { LatLngAlt, ILatLngTime } from "../../../models/models";
...
describe("RoutesService", () => {
    ...
    it("Should split a route", () => {
        let latLng1 = LatLngAlt([0, 0]) as ILatLngTime;
        let latLng2 = LatLngAlt([0.1, 0.1]) as ILatLngTime;
        let segment1 = { latlngs: [latLng1, latLng1], routePoint: latLng1 as LatLngAlt} as IRouteSegment;
        let segment2 = { latlngs: [latLng1, latLng2], routePoint: latLng2 as LatLngAlt} as IRouteSegment;
    ...
    it("Should merge the selected route as the first route", () => {
        ...
        let secondRoute = {
            route: {
                ...
                segments: [
                    { latlngs: [latLng2, latLng1], routePoint: latLng1 as LatLngAlt} as IRouteSegment
                ]
            },
    ...
    it("Should merge the selected route as the last route with markers", () => {
        let latLng1 = LatLngAlt([0, 0]);
        let latLng2 = LatLngAlt([0.1, 0.1]);
        let latLng3 = LatLngAlt([0.2, 0.2]);
        let segment1 = { latlngs: [latLng1, latLng1] as ILatLngTime[], routePoint: latLng1 } as IRouteSegment;
        let segment2 = { latlngs: [latLng1, latLng2] as ILatLngTime[], routePoint: latLng2 } as IRouteSegment;
        initialRouteLayer.getLastLatLng = () => latLng2 as ILatLngTime;
        initialRouteLayer.route.segments = [segment1, segment2];
