...
export type RouteDataWithoutSate = components["schemas"]["RouteData"];
export type RouteData = Omit<RouteDataWithoutSate, "markers"> & { state: RouteEditStateType, markers: MarkerData[] };
