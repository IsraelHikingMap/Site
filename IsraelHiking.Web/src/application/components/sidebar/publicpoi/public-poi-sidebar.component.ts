...
import { AddPrivatePoiAction, AddRouteAction, RoutesReducer } from "../../../reducers/routes.reducer";
import { PointsOfInterestReducer, SetSelectedPoiAction, SetSidebarAction, SetUploadMarkerDataAction } from "../../../reducers/poi.reducer";
import type {
    LinkData,
    LatLngAlt,
    ApplicationState,
