...
export class ResourcesService {
    ...
    public offlinePurchaseGratitude: string;
    public mapeakPro: string;
    ...
    public unableToUploadPoint: string;
    ...
    public turnOffBatteryOptimization: string;
    ...
    public recommendOfflineDownload: string;
    ...
    private async setLanguageInternal(language: Language): Promise<void> {
        await this.gettextCatalog.loadRemote(Urls.translations + language.code + ".json?sign=1786643683171");
        this.about = this.gettextCatalog.getString("About");
        this.legend = this.gettextCatalog.getString("Legend");
        this.clear = this.gettextCatalog.getString("Clear");
        this.editPoint = this.gettextCatalog.getString("Edit Point");
        ...
        this.mapsAndOverlays = this.gettextCatalog.getString("Maps and Overlays");
        ...
        this.deletePoint = this.gettextCatalog.getString("Delete Point");
        ...
        this.copyLink = this.gettextCatalog.getString("Copy Link");
        ...
        this.uploadTrace = this.gettextCatalog.getString("Upload a trace");
        ...
        this.emptyPoiDescription = this.gettextCatalog.getString("Add a description here by clicking the edit button above.");
        ...
        this.uploadPoint = this.gettextCatalog.getString("Upload point to OpenStreetMap");
        ...
        this.baseMaps = this.gettextCatalog.getString("Base Maps");
        ...
        this.offlinePurchaseGratitude = this.gettextCatalog.getString("Thanks for purchasing! download instructions here...");
        this.mapeakPro = this.gettextCatalog.getString("Mapeak Pro");
        ...
        this.unableToExport = this.gettextCatalog.getString("Unable to export...");
        ...
        this.unableToUploadPoint = this.gettextCatalog
            .getString("Unable to upload the point to OpenStreetMap, please try again later...");
        ...
        this.turnOffBatteryOptimization = this.gettextCatalog
            .getString("For reliable tracking, turn off battery optimization for this app in your device settings.");
        ...
        this.recommendOfflineDownload = this.gettextCatalog
        ...
        this.thisWillDeleteAllCurrentRoutesAreYouSure = this.gettextCatalog
        ...
        this.newVersionAvailable = this.gettextCatalog.getString("A new app version is available. Do you want to update?");
        ...
        this.legendSeasonalLake = this.gettextCatalog.getString("Seasonal Lake or Reservoir, Dry Riverbed, Wetland");
        ...
        this.legendRunwayTaxiway = this.gettextCatalog.getString("Airfield with Runway and Taxiway");
        ...
        this.legendBorders = this.gettextCatalog.getString("Borders and Special Areas");
