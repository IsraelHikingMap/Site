...
namespace IsraelHiking.DataAccess.ElasticSearch
{
    public class ElasticSearchHelper : BaseNssmHelper
    {
        ...
        protected override string CommandLine => "java -Delasticsearch -Des-foreground=yes -Des.path.home=\"./ \" -cp \"lib/elasticsearch-2.3.5.jar;lib/*\" \"org.elasticsearch.bootstrap.Elasticsearch\" start";
